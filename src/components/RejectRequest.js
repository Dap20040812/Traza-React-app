...
import { acceptedRequest, rejectRequest } from '../backend/statusRequest'
         ...
         <Data>
           <Form1 onSubmit={handleSubmit}>
            ...
            <Form.Group className='col-md-4 w-100'>
                <Form.Label id="comen1" className="form-label">Motivos del Rechazo :</Form.Label>
                <textarea id="comen" rows="3" placeholder="Motivos del Rechazo" className="form-control" onChange={ e => setField('comentarios', e.target.value) } required/>
            </Form.Group>
            <Form.Group>
